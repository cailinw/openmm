...
#[no_mangle]
pub extern "C" fn initializeData(contextId: u32, numParticles: i32) {
    // set time to 0.0
    // set stepCount to 0
    // set numParticles to numParticles
...
#[no_mangle]
pub extern "C" fn getTime(contextId: u32) -> f64 {
    // TODO: Implement this
}

#[no_mangle]
pub extern "C" fn setTime(contextId: u32, time: f64) {
    // TODO: Implement this
}

#[no_mangle]
pub extern "C" fn getStepCount(contextId: u32) -> i32 {
}

#[no_mangle]
pub extern "C" fn setStepCount(contextId: u32, stepCount: i32) {
}

#[no_mangle]
pub extern "C" fn getNumParticles(contextId: u32) -> i32{
}

#[no_mangle]
pub extern "C" fn setNumParticles(contextId: u32, numParticles: i32) {
}

#[no_mangle]
pub extern "C" fn setPositions(contextId: u32, positions: *mut Vec3, size: i32) {
    // TODO: Implement this
}

#[no_mangle]
pub extern "C" fn getPositions(contextId: u32, positions: *mut Vec3) {
    // size is numParticles stored in data, or size can be passed as parameter
}

#[no_mangle]
pub extern "C" fn setVelocities(contextId: u32, velocities: *mut Vec3) {
    // size is numParticles stored in data, or size can be passed as parameter
}

#[no_mangle]
pub extern "C" fn getVelocities(contextId: u32, velocities: *mut Vec3) {
    // size is numParticles stored in data, or size can be passed as parameter
}

#[no_mangle]
pub extern "C" fn setForces(contextId: u32, forces: *mut Vec3) {
    // size is numParticles stored in data, or size can be passed as parameter
}

#[no_mangle]
pub extern "C" fn getForces(contextId: u32, forces: *mut Vec3) {
    // size is numParticles stored in data, or size can be passed as parameter
}

#[no_mangle]
pub extern "C" fn setPositions(contextId: u32, positions: *mut Vec3) {
    // size is numParticles stored in data, or size can be passed as parameter
}
